        ...
        if tool_name == "getenvelope":
            ...
            if USE_REAL_APIS:
                ...
                return {
                    ...
                    "message": "Mock demo envelope created"
                }
            ...
            if USE_REAL_APIS:
                ...
                return {
                    ...
                    "message": "Mock DocuSign configuration"
                }
...
if __name__ == "__main__":
    logger.info("Starting SSE-compatible MCP server on 0.0.0.0:8000")
